...
// Rest syntax is the opposite of spread syntax: spread 'expands' an array into its elements (creates a comma-separated list from an array),
// while rest collects multiple elements and 'condenses' them into a single element (creates an array from a comma-separated list).

const prices = [10.99, 5.99, 2.99];
console.log(Math.min(...prices)); // create comma-separated list from array
