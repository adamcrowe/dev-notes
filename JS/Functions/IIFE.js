...
console.log(result[1]()); 	// 5 - because `i` isn't block scoped to each iteration - see alt 3
console.log(result[3]()); 	// 5 - because `i` isn't block scoped to each iteration - see alt 3
