...
git remote -v2											# list remotes and their urls for the current git project
git remote show original								# display remote branches and endpoints for pulling and pushing
...
git config --global --editing							# open the global configuration file in a text editor for manual editing
...
git config --global user.name "Alice Bob"				# change author/committer name globally
git config --global user.email "alice@bob.com"			# change author/committer email globally

git config user.name "Alice Bob"						# change author/committer name on current repo
git config user.email "alice@bob.com"					# change author/committer email on current repo

git commit --amend --author="Alice Bob <alice@bob.com>" # amend author/committer for very latest commit
